...
VALIDATION ISSUES:
{
  ...
  "issues": [
    "salesforce bullet 1 has 19 words; target is 15.",
  ...
  "experiences": [
    {
      ...
      "continuation": false,
      "bullets": [
        "Maintained execution plans, reporting cadence, and risk tracking, converting ambiguous BPA priorities into a measurable 30-60-90 roadmap.",
        ...
        "Operationalized AI-assisted knowledge workflows with SME validation, metadata tagging, publishing templates, and link correction, reducing turnaround 80% across roughly 80 articles while improving content discoverability.",
        "Managed global process-map updates across AR groups, driving Bad Debt documentation to 100% completion.",
        "Built BPA operating cadences with weekly reporting, success metrics, risk reviews, and recommendations, improving leadership visibility into completed work, impact, quarterly priorities, and next actions."
      ]
    },
    {
      "key": "marketmaker_pm",
      ...
      "bullets": [
        ...
        "Coordinated development, product, sales, marketing, and leadership teams to remove blockers, sustain execution clarity, and keep strategic initiatives aligned with company priorities and delivery goals.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Aligned development, sales, marketing, CTO, and CSO stakeholders across new features and initiatives, bridging technical delivery with business priorities to accelerate execution and decisions.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Managed scope, budget, resources, timelines, and delivery risks while negotiating executive priorities to balance business needs, technical feasibility, execution capacity, and leadership visibility.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Standardized validation workflows, defect reporting, testing documentation, quality controls, and repeatable testing practices to improve consistency, traceability, and governance across application delivery cycles.",
        "Developed Tableau reporting and root-cause analysis to improve visibility into system issues and bottlenecks.",
        "Modernized QA workflows using Azure DevOps, Tableau, Citrix, VB, Compare, and structured testing practices, improving defect visibility, validation consistency, and delivery efficiency."
      ]
    }
  ],
  "skills": {
