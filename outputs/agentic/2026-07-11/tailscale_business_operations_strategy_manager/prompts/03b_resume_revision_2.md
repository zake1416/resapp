  ...
  "experiences": [
    {
      ...
      "bullets": [
        ...
        "Established post-implementation controls measuring adoption, KPI improvement, policy adherence, compliance, sustainability, and benefits realization to strengthen governance, accountability, and sustained operating performance across workflows."
      ]
    },
    {
      "key": "marketmaker_pm",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Analyzed commercial property data with SQL to improve customer-listing alignment, support leadership decisions, and contribute to a 22% increase in customer retention outcomes.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Connected AI, analytics, workflow automation, and client-service improvements into a scalable operating model supporting Vista’s shift toward technology-driven business growth and future expansion.",
        "Managed scope, budget, resources, timelines, and risks while negotiating executive priorities and delivery tradeoffs.",
        "Improved platform usability, service delivery, and client experience by aligning product workflows, analytics outputs, and communication strategies with client needs and decision-making behaviors."
      ]
    },
    {
      "key": "ltimindtree",
      ...
      "bullets": [
        ...
        "Connected root-cause analysis, performance insights, and Tableau reporting to client business outcomes by identifying system bottlenecks contributing to a projected $1M revenue increase.",
        "Validated ETL processes, data accuracy, and migration correctness across 22 projects using Azure DevOps.",
        "Modernized QA operations with Azure DevOps, Tableau, Citrix, VB, Compare, and structured testing practices to improve defect visibility and support more efficient delivery."
      ]
    }
  ],
  "skills": {
