...
CURRENT RESUME JSON:
{
  "summary": "Business operations analyst with experience in process improvement, data validation, compliance documentation, reporting, systems coordination, and cross-functional execution across revenue operations, analytics platforms, and business systems.",
  "experiences": [
    {
      "key": "salesforce",
      "company": "Salesforce",
      ...
      "continuation": false,
      "bullets": [
        "Applied advanced PC, reporting, and data-entry discipline to align AOV inputs, definitions, and stakeholder requirements.",
        "Processed and audited revenue operations documentation, SOX ELC.8 controls, and governance reviews, strengthening compliance readiness while reducing control risk across financial reporting routines.",
        ...
        "Established continuous-improvement sequencing across discovery, auditing, solution development, implementation, and monitoring workstreams.",
    ...
    },
    {
      ...
      "continuation": false,
      "bullets": [
        "Validated platform data, calculations, and product reliability through test scripts, strengthening user confidence.",
        "Supported multi-department operations by aligning technology infrastructure, product flows, internal systems, and leadership priorities with evolving business needs for scalable execution and clearer structure.",
    ...
    },
    {
      ...
      "continuation": true,
      "bullets": [
        "Performed data entry validation across system accuracy, data flows, calculations, and platform functionality using QA scripts.",
        "Mapped operating charts and identified process optimization opportunities, reducing complexity while improving execution consistency across internal teams, business systems, and platform support routines.",
    ...
    },
    {
      ...
      "continuation": false,
      "bullets": [
        "Managed requirements, backlog priorities, milestones, and sprint planning in JIRA for analytics platform delivery.",
        "Automated platform steps for internal teams and external clients, reducing manual friction while improving usability, service consistency, and end-to-end user experience.",
        "Improved client experience by aligning product flows, analytics outputs, and communications with customer decision needs.",
        "Managed scope, budget, resources, timelines, and delivery risks while negotiating priorities with executive leadership to balance business needs, technical feasibility, and execution capacity."
      ]
    },
    {
      "key": "ltimindtree",
      ...
      "bullets": [
        ...
        "Led ETL testing during migration to identify data inconsistencies, system defects, and migration risks, improving defect detection by 60% and post-migration confidence.",
        "Modernized QA validation using Azure DevOps, Tableau, Citrix, VB, and Compare for stronger defect visibility.",
        "Developed Tableau visualizations and root-cause analysis for client system issues, performance bottlenecks, and quality trends, supporting targeted improvements tied to $1M impact."
      ]
    }
  ],
  "skills": {
