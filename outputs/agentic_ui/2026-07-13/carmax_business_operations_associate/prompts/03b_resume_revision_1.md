...
VALIDATION ISSUES:
{
  ...
  "issues": [
    "Resume repeats 'workflow' in 7 bullets; reduce keyword stuffing.",
    "salesforce bullet 6 has 23 words; target is 28.",
    "marketmaker_pm bullet 2 has 20 words; target is 28.",
    "marketmaker_ba bullet 2 has 18 words; target is 28.",
    "vista bullet 2 has 21 words; target is 28.",
...
CURRENT RESUME JSON:
{
  "summary": "Business operations analyst with experience in data accuracy, audit-ready documentation, workflow improvement, reporting, controls, and cross-functional execution across business systems, revenue operations, SaaS platforms, and analytics environments.",
  "experiences": [
    {
      "key": "salesforce",
      "company": "Salesforce",
      ...
      "bullets": [
        ...
        "Built a continuous-improvement cadence sequencing discovery, auditing, solution development, implementation, and monitoring across business units, strengthening workflow consistency and reducing process friction."
      ]
    },
    {
      "key": "marketmaker_pm",
      ...
      "bullets": [
        ...
        "Improved systems and internal workflows for scale by aligning technology infrastructure, product processes, and leadership priorities with evolving business needs.",
    ...
    },
    {
      ...
      "continuation": true,
      "bullets": [
        "Validated system accuracy, data flows, calculations, and functionality to maintain reliable client-facing SaaS operations.",
        "Mapped system workflows and identified process optimization opportunities, reducing operational complexity and improving execution efficiency across internal teams.",
    ...
    },
    {
      ...
      "continuation": false,
      "bullets": [
        "Managed requirements, roadmap priorities, sprint planning, and JIRA milestones to support disciplined platform execution.",
        "Automated platform workflows for internal teams and external clients, reducing manual friction and creating a smoother end-to-end analytics experience.",
        "Improved client service by aligning platform workflows, analytics outputs, and communications with user needs.",
        "Managed scope, budget, resources, timelines, and delivery risks while negotiating priorities with leadership to balance business needs, technical feasibility, and capacity."
      ]
    },
    {
      "key": "ltimindtree",
      ...
      "continuation": false,
      "bullets": [
        "Standardized testing documentation, validation workflows, defect reports, and practices to improve delivery traceability.",
        "Led ETL testing during migration, identifying data inconsistencies and system defects while improving defect detection by 60% and reducing post-migration risk.",
        "Modernized QA workflows using Azure DevOps, Tableau, Citrix, VB, and Compare to improve defect visibility.",
        "Developed Tableau visualizations and root cause analysis for clients, clarifying system issues, bottlenecks, and quality trends supporting targeted application improvements."
      ]
    }
  ],
  "skills": {
