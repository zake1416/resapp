...
VALIDATION ISSUES:
{
  ...
  "issues": [
    ...
    "ltimindtree bullet 4 has 21 words; target is 28."
  ]
}
...
CURRENT RESUME JSON:
{
  "summary": "Business operations analyst with experience in documentation accuracy, control execution, data validation, process improvement, reporting, and cross-functional coordination across revenue operations, business systems, SaaS platforms, and analytics environments.",
  "experiences": [
    {
      "key": "salesforce",
      "company": "Salesforce",
      ...
      "bullets": [
        ...
        "Maintained audit-ready transaction documentation and SOX ELC.8 controls through governance reviews, self-inspection, accurate reporting, proactive risk identification, and disciplined control execution.",
        ...
        "Standardized net-new AOV reporting inputs and definitions to improve Credit and Collections decision accuracy.",
        "Sequenced business units through discovery, audits, solution development, implementation, monitoring, and enablement planning, creating a repeatable continuous-improvement operating rhythm across teams."
      ]
    },
    {
      "key": "marketmaker_pm",
      ...
      "bullets": [
        ...
        "Aligned technology infrastructure, product processes, internal systems, and leadership priorities with evolving business needs to improve operating consistency and support scalable tech-driven solutions.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Clarified data-entry and system procedures by mapping process steps, identifying optimization opportunities, documenting system flows, and improving execution efficiency across internal teams.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Simplified analytics-platform interactions for internal teams and external clients by reducing manual friction, automating repetitive steps, and improving the end-to-end user experience.",
    ...
    },
    {
      ...
      "continuation": false,
      "bullets": [
        "Improved documentation accuracy by standardizing testing records, validation practices, defect reports, and quality controls.",
        "Led ETL testing during migration to identify data inconsistencies, system defects, and migration risks, improving defect detection by 60% and strengthening release confidence.",
        "Modernized QA operations using Azure DevOps, Tableau, Citrix, VB, and Compare to improve defect visibility.",
        "Developed Tableau visualizations and root cause analysis for clients, clarifying system issues, performance bottlenecks, quality trends, and targeted application improvement opportunities."
      ]
    }
  ],
  "skills": {
