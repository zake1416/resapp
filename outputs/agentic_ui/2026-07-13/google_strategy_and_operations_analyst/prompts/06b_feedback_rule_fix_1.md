...
VALIDATION ISSUES:
{
  ...
  "issues": [
    "marketmaker_ba bullet 1 should start with a stronger action verb; found 'Partnered'.",
    "marketmaker_ba bullet 2 should start with a stronger action verb; found 'Identified'.",
    "vista bullet 2 should start with a stronger action verb; found 'Positioned'.",
    "vista bullet 3 should start with a stronger action verb; found 'Advised'.",
    "marketmaker_pm bullet 2 is too similar to marketmaker_ba bullet 2; shared terms: analysis, client, future, insight, leadership, modeling.",
    "salesforce bullet 1 has 21 words; target is 15.",
    "salesforce bullet 3 has 23 words; target is 15.",
    "marketmaker_pm bullet 3 has 23 words; target is 15.",
    "marketmaker_ba bullet 1 has 22 words; target is 15.",
    "vista bullet 3 has 19 words; target is 15."
  ]
}
...
CURRENT RESUME JSON:
{
  "summary": "Strategy and operations analyst with experience generating insights, defining roadmaps, aligning executive and cross-functional stakeholders, improving workflows, and guiding change initiatives across RevOps, GTM support, product analytics, AI enablement, reporting, and customer-facing systems.",
  "experiences": [
    {
      "key": "salesforce",
      "company": "Salesforce",
      ...
      "continuation": false,
      "bullets": [
        "Synthesized PAM findings, QBR insights, KPIs, and controls into business recommendations guiding cash-flow, compliance, customer experience, automation, and scalability decisions.",
        ...
        "Drove referral strategy with unique links, customer-facing teams, internal competition, and weekly dashboards, generating 50,000+ Billing Portal logins within two months.",
        ...
        "Monitored Innovation Days solutions against success measures, strengthening benefits realization, control effectiveness, adoption, and operational sustainability.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Built reports and visualizations that guided clients and internal teams through property-data decisions, strengthening sales enablement visibility and client portfolio growth support."
      ]
    },
    {
      "key": "marketmaker_ba",
      ...
      "continuation": true,
      "bullets": [
        "Partnered directly with CTO and CSO leadership to align technical roadmaps with product development, go-to-market needs, and long-term strategy.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Advised Vista's president on AI use cases, emerging technologies, and analytics integration, improving executive understanding of transformation opportunities.",
