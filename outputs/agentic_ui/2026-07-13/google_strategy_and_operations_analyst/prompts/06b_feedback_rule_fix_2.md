...
VALIDATION ISSUES:
{
  ...
  "issues": [
    "salesforce bullet 3 should start with a stronger action verb; found 'Mobilized'.",
    "marketmaker_ba bullet 2 should start with a stronger action verb; found 'Scoped'.",
    "vista bullet 2 should start with a stronger action verb; found 'Consulted'.",
    "salesforce bullet 1 has 25 words; target is 15.",
    "salesforce bullet 3 has 21 words; target is 15.",
    "salesforce bullet 6 has 23 words; target is 28.",
    "marketmaker_ba bullet 2 has 17 words; target is 28.",
...
CURRENT RESUME JSON:
{
  "summary": "Strategy and operations analyst experienced in insight generation, roadmap definition, stakeholder alignment, workflow improvement, and change execution across RevOps, GTM support, product analytics, AI enablement, reporting, and customer-facing systems.",
  "experiences": [
    {
      "key": "salesforce",
      "company": "Salesforce",
      ...
      "continuation": false,
      "bullets": [
        "Synthesized PAM findings, QBR insights, KPIs, and control data into business recommendations guiding cash-flow, compliance, customer experience, automation, scalability, and portfolio decisions for leadership.",
        "Defined roadmaps from V2MOM priorities and leadership objectives, aligning Finance, Revenue Operations, Systems, Sales Operations, M&A, Audit, and Customer Service around governed change initiatives.",
        "Mobilized referral links, customer-facing teams, internal competition, and weekly dashboards to generate 50,000+ Billing Portal logins within two months.",
        ...
        "Coordinated execution across 13 enterprise stakeholder groups, clarifying ownership and dependencies for AR initiatives spanning finance, systems, sales operations, audit, service, and controls."
      ]
    },
    {
      "key": "marketmaker_pm",
      ...
      "bullets": [
        ...
        "Defined product roadmap opportunities for predictive modeling and sentiment analysis, expanding planned analytics capabilities while framing future revenue options and client-value potential for leadership.",
        "Built property-data reports and visualizations guiding client decisions and internal priorities across portfolio analysis."
      ]
    },
    {
      "key": "marketmaker_ba",
      ...
      "continuation": true,
      "bullets": [
        "Aligned CTO and CSO priorities with technical roadmaps, product development, go-to-market needs, and long-term strategy.",
        "Scoped unlaunched predictive modeling and sentiment analysis concepts to expand differentiation, client insight, and future revenue potential.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Consulted with clients on analytics and research services, aligning needs to product capabilities while strengthening engagement, trust, and long-term partnership opportunities for GTM support.",
        "Guided Vista's president on AI use cases, emerging technologies, and analytics integration, improving executive understanding of transformation opportunities.",
        "Refined client experience by simplifying usability, analytics outputs, and communication strategies, helping users interpret services faster while improving product-value realization across research workflows."
      ]
    },
    {
      "key": "ltimindtree",
      ...
      "bullets": [
        ...
        "Developed Tableau visualizations for system issues, performance bottlenecks, and quality trends, giving clients clearer decision support for targeted application improvements and operational priorities."
      ]
    }
  ],
  "skills": {
