...
VALIDATION ISSUES:
{
  ...
  "issues": [
    "marketmaker_pm bullet 1 has 23 words; target is 15.",
    "marketmaker_ba bullet 1 has 22 words; target is 15."
  ]
}

JD PROFILE:
{
  "role_title": "Assistant Business Manager – Executive & Strategic Operations",
  "company_name": "GSMA",
  "role_families": [
    "process_improvement",
    "program",
  ...
  "responsibility_phrases": [
    "Gene Sanders Jr. Executive Business Manager, Chairman, CEO and CCO Office",
    "For CDP reporting, the Assistant Business Manager will work with GSMA’s external sustainability partner, to support data collection, coordination, timelines, documentation, and related reporting deliverables.",
    "In your first year, you’ll build strong foundations in project coordination, executive support, global event delivery, and sustainability reporting, with support from the team as you grow in confidence and responsibility.",
    "In return, you’ll gain broad exposure to GSMA initiatives and events, while building experience in project management, stakeholder engagement, sustainability, and executive operations in a supportive team environment.",
    "Experience With The Following Systems Would Be Beneficial",
    "SharePoint, Asana, Smartsheet, Salesforce, Monday.com, or similar project management systems"
  ],
  ...
  "experiences": [
    {
      ...
      "selected_points": [
        ...
        {
          "id": "SFC_073",
          "legacy_id": "SFDC_AI_007",
          "duplicate_of": "",
          "point_title": "Financial Control Automation Roadmap",
          "base_resume_point": "Developed an executive roadmap for automating manual financial controls and establishing repeatable automation pathways for newly introduced control requirements.",
          "core_competency": [
          ...
          "functional_skill": [
            ...
            "Manual control analysis",
            "Automation pathway design",
            "Control requirement planning",
            "Financial governance alignment",
            "Repeatable framework design",
            "Project plan management",
            "Timeline and milestone management",
            "Deliverable tracking",
            "Implementation planning",
          ...
          "business_outcome": [
            ...
            "Reduced manual control burden",
            "Created repeatable control automation pathway",
            "Strengthened executive visibility into automation strategy",
            "Improved project visibility",
            "Strengthened delivery accountability",
            "Improved implementation readiness",
            "Reduced software onboarding risk",
          ...
          "evidence_proof": [
            "Developed executive roadmap",
            "Focused on automating manual financial controls",
            "Established repeatable automation pathways",
            "Supported newly introduced control requirements",
            "Connected roadmap with control governance needs"
          ],
          "metrics": [],
          "best_fit_roles": [
          ...
          "adaptation_direction": [
            "For AI Transformation Analyst roles, frame as designing an executive roadmap for financial control automation.",
            "For AI Operations Analyst roles, frame as creating repeatable automation pathways for control requirements.",
            "For Strategy & Operations Associate roles, frame as executive roadmap development for scalable control transformation.",
            "For Enterprise Project Manager roles, frame as project planning, milestone governance, delivery tracking, and executive-ready status communication.",
            "For enterprise software implementation roles, frame as readiness planning, cross-functional execution, risk tracking, and delivery governance across system or workflow changes.",
            "For regulated program environments, frame as governance discipline, compliance tracking, audit readiness, and documented decision control.",
            "For Project Manager roles, frame as coordinating business, systems, executive, and operational stakeholders around timelines, risks, decisions, and delivery ownership.",
        ...
        {
          "id": "SFC_049",
          "legacy_id": "SFDC_PAM_007",
          "duplicate_of": "",
          "point_title": "Business-Unit PAM Insight Conversion",
          "base_resume_point": "Converted insights from business-unit PAM meetings into process-audit priorities, BPI opportunities, corrective actions, stakeholder commitments, capacity decisions, and portfolio-planning inputs.",
          "core_competency": [
          ...
          "functional_skill": [
            "Meeting insight synthesis",
            "Audit priority definition",
            "BPI opportunity mapping",
          ...
          "business_outcome": [
            "Improved follow-through from operating reviews",
            "Converted discussion into execution",
            "Improved audit and BPI prioritization",
            "Strengthened portfolio planning inputs",
            "Improved project visibility",
            "Strengthened delivery accountability",
            "Strengthened compliance readiness",
            "Reduced governance gaps",
          ...
          "evidence_proof": [
            "Converted PAM meeting insights into process-audit priorities",
            "Converted insights into BPI opportunities",
            "Created corrective actions from PAM discussions",
            "Tracked stakeholder commitments",
            "Translated insights into capacity decisions and portfolio-planning inputs"
          ],
          "metrics": [],
          "best_fit_roles": [
            "Strategy & Operations Associate",
          ...
          "adaptation_direction": [
            "For Strategy & Operations Associate roles, frame as converting leadership discussions into operating priorities and planning inputs.",
            "For Process Improvement Analyst roles, frame as translating PAM insights into audit priorities and BPI opportunities.",
            "For Program Analyst roles, frame as tracking commitments, capacity decisions, and planning follow-through.",
            "For Enterprise Project Manager roles, frame as project planning, milestone governance, delivery tracking, and executive-ready status communication.",
            "For regulated program environments, frame as governance discipline, compliance tracking, audit readiness, and documented decision control.",
            "For Project Manager roles, frame as coordinating business, systems, executive, and operational stakeholders around timelines, risks, decisions, and delivery ownership.",
            "For process-improvement-heavy PM roles, frame as translating process gaps into governed improvement plans, implementation actions, and measurable operating improvements.",
  ...
  "experiences": [
    {
      ...
      "continuation": false,
      "bullets": [
        "Coordinated reporting inputs, timelines, documentation, governance requirements, and stakeholder follow-through to improve leadership visibility across enterprise initiatives.",
        "Improved business systems flow across Finance, Revenue Operations, Systems, Sales Operations, M&A, Audit, and Customer Service, clarifying ownership and dependencies across 13 enterprise initiatives.",
        "Built portfolio governance and milestone trackers, sustaining 85% of supported deliverables in green status.",
        "Translated V2MOM priorities, PAM findings, QBR insights, and operational risks into strategic roadmaps, measurable initiatives, and governance decisions supporting cash flow, compliance, automation, and customer experience.",
        "Developed executive roadmap for financial control automation, creating repeatable pathways for new control requirements and compliance documentation.",
        "Coordinated approved BPI implementations with operations leaders, Systems teams, reporting partners, SMEs, process owners, and frontline stakeholders to strengthen execution clarity and reduce process friction."
      ]
    },
    {
      "key": "marketmaker_pm",
      ...
      "continuation": false,
      "bullets": [
        "Served as liaison between senior executives and cross-functional teams, translating leadership priorities into project plans, risk updates, and decision-ready progress reporting.",
        "Supported project coordination and executive operations by expanding from analyst intern to project manager across business analysis, product execution, cross-functional ownership, and strategic startup initiatives.",
        "Created reports and visualizations from property analysis, improving decision support for internal teams and clients."
      ]
    },
    {
      "key": "marketmaker_ba",
      ...
      "continuation": true,
      "bullets": [
        "Coordinated cross-functional execution across development, sales, marketing, and leadership teams to accelerate initiatives and keep business priorities aligned with delivery activity.",
        "Supported SaaS operating systems across product, finance, internal workflows, and growth initiatives, strengthening execution structure, business analysis coverage, and scalable delivery in a startup environment.",
        "Analyzed property data with SQL, improving listing alignment and contributing to 22% customer retention growth."
      ]
    },
    {
      "key": "vista",
      ...
      "continuation": false,
      "bullets": [
        "Managed scope, budgets, resources, timelines, and delivery risks while negotiating priorities with executive leadership.",
        "Owned product execution by defining requirements, prioritizing roadmaps, coordinating development activities, and tracking JIRA milestones to convert a business opportunity into a scalable analytics platform.",
        "Improved client experience by aligning product workflows, analytics outputs, and service communication with client needs.",
        "Led sprint planning, backlog prioritization, and JIRA execution tracking to strengthen delivery visibility, coordinate development activity, and keep product work aligned with business priorities."
      ]
    },
    {
      "key": "ltimindtree",
      ...
      "continuation": false,
      "bullets": [
        "Led Agile SDLC coordination, backlog prioritization, Scrum practices, and risk tracking, improving efficiency 60%.",
        "Standardized testing processes through repeatable documentation, validation workflows, defect reports, and quality practices, improving consistency, traceability, and control across application delivery cycles for client-facing release readiness.",
        "Built Tableau visualizations and root cause analyses to clarify system issues, bottlenecks, quality trends, and reporting deliverables.",
        "Connected quality engineering, root cause analysis, and performance insights to business outcomes, identifying system improvements that contributed to a projected $1M client revenue increase."
      ]
    }
  ],
  "skills": {
