...
VALIDATION ISSUES:
{
  ...
  "issues": [
    ...
    "ltimindtree bullet 2 has 21 words; target is 28.",
...
CURRENT RESUME JSON:
{
  "summary": "Business operations lead experienced in product delivery, workflow consistency, cross-functional coordination, governance, business systems, analytics platforms, Agile delivery, customer-facing launches, and operational programs.",
  "experiences": [
    {
      "key": "salesforce",
      "company": "Salesforce",
      ...
      "continuation": false,
      "bullets": [
        "Drove product delivery by translating V2MOM priorities, PAM findings, and QBR insights into governed roadmaps.",
        "Orchestrated cross-team coordination by assessing strategic value, capacity, risks, dependencies, and resources, guiding leaders on portfolio tradeoffs across business systems, operations initiatives, and controls.",
        "Led global Billing Portal execution from initiation through post-launch support, aligning scope, controls, communications, and readiness.",
        "Built AR Operations governance with roadmaps, milestone trackers, PMO alignment, executive reporting, backlog refinement, and biannual prioritization cycles, sustaining 85% green deliverables.",
        "Developed capacity planning connecting project demand, implementation effort, SME constraints, dependencies, and BAU commitments.",
        "Coordinated Systems and UAT execution as AR Operations liaison, aligning requirements, validation, issue resolution, readiness tracking, and stakeholders for smoother business-system releases."
      ]
    },
    {
      "key": "marketmaker_pm",
      ...
      "continuation": false,
      "bullets": [
        "Drove product delivery by expanding ownership across business analysis, product execution, and strategic initiatives.",
        "Coordinated operating rhythm across development, product, sales, marketing, CTO, and CSO stakeholders to align timelines, priorities, risks, and company growth goals.",
    ...
    },
    {
      ...
      "continuation": true,
      "bullets": [
        "Advanced startup execution across product, finance, operations, internal systems, and technical growth initiatives.",
        "Aligned development, sales, marketing, CTO, and CSO stakeholders around technical delivery and business priorities, accelerating new features and improving execution clarity.",
    ...
    },
    {
      ...
      "continuation": false,
      "bullets": [
        "Drove product delivery by defining requirements, prioritizing roadmaps, and managing delivery milestones.",
        "Managed Agile cadence through JIRA sprint planning, backlog prioritization, timeline tracking, and execution coordination, aligning product development with business priorities and delivery goals.",
    ...
    },
    {
      ...
      "continuation": false,
      "bullets": [
        "Drove release quality for a business-critical reinsurance web application supporting client-facing delivery.",
        "Standardized validation workflows, defect reports, test cases, scenarios, and structured testing practices, improving consistency, traceability, and quality across application delivery cycles.",
